...
const Home = () => {
    return (
        <div>
            ...
            <div>
                <p>
                    I'm a <b>Software Engineer</b> who loves <i>music</i>, <i>science</i>, and <i>sustainability</i>. I
                    also occasionally <Link to="/blog">write</Link>.
                </p>
                <p>
                    I specialise in <b>backend</b> and <b>machine learning</b> systems, and I currently work on things
                    like this at <a href="https://arenko.group/">Arenko</a>.
                </p>
                <p>
                    I studied <b>mathematics</b> at Imperial where I spent a lot of time researching{" "}
                    <a href="https://github.com/petermnhull/MastersProject">mathematical sperm cells</a>.
                </p>
            </div>
            <div id="footer">
