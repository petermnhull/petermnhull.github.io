...
Next, Jonathan Amsterdam, a Software Engineer at Google who works on Go, gave a talk on the Standard Logging library introduced in Go 1.21. This is one of the most highly anticipated additions to the language in 2023.
